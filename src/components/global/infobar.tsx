...
import { SheetContent, SheetTrigger,Sheet, SheetHeader, SheetTitle, SheetDescription } from '../ui/sheet'
                ...
                <Sheet>
                    ...
                    <SheetContent className='mt-4 mr-4 pr-4 flex flex-col'>
                        ...
                        {allNotifications?.length === 0 && (
                            <div className="flex items-center justify-center mb-4 text-muted-foreground">You have no notifications</div>
                        )}
                    </SheetContent>
                </Sheet>
                <ModeToggle/>
