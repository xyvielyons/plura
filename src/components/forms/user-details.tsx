...
const UserDetails = ({id,type,userData,subAccounts}:Props) => {
    const [subAccountPermissions,setSubAccountsPermission] = useState<UserWithPermissionsAndSubAccounts | null>(null)
    ...
    useEffect(()=>{
        ...
        const getPermissions = async()=>{
            ...
            setSubAccountsPermission(permissions)
        }
        getPermissions()
    },[data,form])
        ...
        <CardContent>
            <Form {...form}>
                ...
                <FormField
                                ...
                                <Select 
                                    ...
                                    onValueChange={(value)=>{
                                        if(value === 'SUBACCOUNT_USER' || value === 'SUBACCOUNT_GUEST'){
                                            setRoleState("Ypu need to have subaccounts to assign Subaccount access to team members")
                                        }else{
                                            setRoleState('')
                                        }
                                ...
                                >
                                    <FormControl>
                                        ...
                                        <SelectContent>
                                            ...
                                            {(data?.user?.role === "AGENCY_ADMIN" || userData?.role === "AGENCY_OWNER") && (
                    ...
                    disabled={form.formState.isSubmitting}
                    type='submit'
                    >{form.formState.isSubmitting ? <Loading></Loading> : 'Save User Details'}</Button>
                    
                    {authUserData?.role === "AGENCY_OWNER" && <div>
